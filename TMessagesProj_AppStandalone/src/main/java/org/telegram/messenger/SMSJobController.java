...
public class SMSJobController implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static class SIM {
        ...
        public static SIM from(SubscriptionManager subscriptionManager, SubscriptionInfo info) {
            if (subscriptionManager == null || info == null) {
                return null;
            }
            ...
            try {
                ...
                FileLog.w("SMS jobs: phone number permission was revoked");
            } catch (RuntimeException telephonyFailure) {
                
                FileLog.e(telephonyFailure);
            }
            try {
                return new SIM(
                ...
                FileLog.w("SMS jobs: SIM metadata permission was revoked");
            } catch (RuntimeException telephonyFailure) {
                FileLog.e(telephonyFailure);
            }
            return null;
    ...
    private static ArrayList<SIM> getSIMs(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= 22) {
            ...
            try {
                ...
                FileLog.w("SMS jobs: SIM permission was revoked");
                return simInfoList;
            } catch (RuntimeException telephonyFailure) {
                FileLog.e(telephonyFailure);
                return simInfoList;
